...
<div class="heading"> <h3> <span class="label label-danger"><?php echo $content['error'];?></span></h3> </div>
 ...
 <section class="col-md-4">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control"  name="login" id="exampleInputLogin1" placeholder="Login" value="<?php if ($content['login']) {echo $content['login'];} else echo "";?>">
  </div>
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="password" class="form-control" name="repeatpass"  id="exampleInputPassword2" placeholder="Repeat password">
  </div>
