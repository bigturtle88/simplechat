...
echo '<div class="row">
<div class="col-xs-12" style="padding:0 0 10px 15px;"> <a href="'.SITE_URL.'admin/room/'.$channel['id'].'"><button type="button" class="btn btn-default col-xs-10">' .$channel['name']. '</button></a>
</div>
...
if(empty($page)) echo '<a href="' .SITE_URL. 'admin/chat">1</a> '; 
else echo '<a href="' .SITE_URL. 'admin/chat/' .$page. '">' .(($page/10)+1). '</a> ';
